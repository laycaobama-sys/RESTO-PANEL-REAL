...
const jsonLd = {
  ...
  "@graph": [
      ...
      offers: [
        {
          ...
          price: "49",
          priceCurrency: "EUR",
          url: `${SITE_URL}/#p-pricing`,
          description: "Para restaurantes independientes. SLA 99.5%, backups diarios, infraestructura compartida, monitorización básica y soporte estándar.",
        },
        {
          "@type": "Offer",
          name: "Professional",
          ...
          priceCurrency: "EUR",
          url: `${SITE_URL}/#p-pricing`,
          description: "Para grupos en crecimiento. SLA 99.9%, backups cada hora, analítica avanzada, prioridad en Workers y soporte prioritario.",
        },
        {
          "@type": "Offer",
          name: "Enterprise",
          ...
          priceCurrency: "EUR",
          url: `${SITE_URL}/#p-pricing`,
          description: "Para cadenas y operaciones multi-país. SLA 99.99%, infraestructura dedicada, multi-región activa, IA dedicada, soporte 24/7, arquitecto técnico y account manager.",
        },
      ],
      featureList: [
    ...
    {
      "@type": "HowTo",
      "@id": `${SITE_URL}/#howto-start`,
      name: "Cómo empezar con RestoPanel",
      description:
        "Pasos para poner en marcha RestoPanel en un restaurante: desde la creación de la cuenta hasta el primer servicio con reservas inteligentes.",
      totalTime: "PT30M",
      estimatedCost: {
        "@type": "MonetaryAmount",
        currency: "EUR",
      ...
      step: [
        {
          ...
          position: 1,
          name: "Crea tu cuenta",
          text: "Regístrate en restopanel.com con tu email. El plan Starter cuesta 49 €/mes e incluye 1 local y 3 usuarios.",
        },
        {
          "@type": "HowToStep",
          position: 2,
          name: "Configura tu local",
          text: "Introduce los datos de tu restaurante: nombre, dirección, horarios, zonas, mesas y turnos de servicio.",
        },
        {
          "@type": "HowToStep",
          position: 3,
          name: "Define tus reglas de reserva",
          text: "Configura duración de mesa por turno, política de no-show, depósito o pre-autorización y canales de confirmación (email, SMS o WhatsApp).",
        },
        {
          "@type": "HowToStep",
          position: 4,
          name: "Activa tu plano de mesas",
          text: "Dibuja tu sala con el editor drag & drop. Cada mesa tiene capacidad, zona y estado en tiempo real.",
        },
        {
          "@type": "HowToStep",
          position: 5,
          name: "Conecta tus canales",
          text: "Enlaza Google Business Profile, WhatsApp Cloud API y tu web para centralizar las reservas en un único panel.",
        },
        {
          "@type": "HowToStep",
          position: 6,
          name: "Lanza tu primer servicio",
          text: "Abre el turno, asigna reservas a mesas y gestiona la sala en tiempo real. Las confirmaciones y recordatorios se envían automáticamente.",
        },
      ],
    },
    {
      ...
      name: "Planes de RestoPanel",
      description:
        "Tres planes escalables: Starter (49 €/mes) para restaurantes independientes, Professional (99 €/mes) para grupos en crecimiento y Enterprise (249 €/mes) para cadenas multi-país.",
      itemListElement: [
        {
          "@type": "Offer",
          name: "Starter",

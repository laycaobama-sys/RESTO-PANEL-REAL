        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-8 gap-3">
          {KPIS.map((k) => (
            <div key={k.label} className="rp-glass rounded-xl p-4 hover:border-[var(--gold)]/30 transition-colors">
              ...
              <div className="mt-1.5 font-display text-xl sm:text-2xl xl:text-[1.7rem] font-light text-foreground">{k.value}</div>
              <div className="mt-2">
          ...
          <div className="flex flex-col sm:flex-row gap-2 p-3 border-b border-border/40">
            ...
            <div className="flex gap-2 flex-wrap">
              <Select value={planFilter} onValueChange={setPlanFilter}>
                <SelectTrigger size="sm" className="w-full sm:w-40" aria-label="Filtrar por plan">
              ...
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                <SelectTrigger size="sm" className="w-full sm:w-36 flex-1 sm:flex-none" aria-label="Filtrar por estado">
